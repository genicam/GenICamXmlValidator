 ...
 * - adding some data to successful or failed test with
 *   failTestAdded() and successfulTestAdded(),
 * - adding some statistics with statisticsAdded(),
 * - adding other data with beginDocument() or endDocument().
 *
 ...
 * member function beginDocument() is overridden where a new
