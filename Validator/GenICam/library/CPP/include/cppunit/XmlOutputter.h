 ...
 *
 * Additional data can be added to the XML document using XmlOutputterHook.
...
public:
   ...
   * is empty at this time), and endDocument() once all the data have been added
   * to the root element.
   */
   ...
   * Creates a new element containing data about the failed test, and adds it to
   ...
   * Creates a new element containing data about the successful test, and adds it to
