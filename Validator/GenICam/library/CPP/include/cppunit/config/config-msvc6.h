...
#pragma warning( disable : 4251 )   // disable warning "class 'xxx' needs to have dll-interface to be used by clients of class 'yyy'"
#pragma warning( disable : 4275 )   // disable warning "non dll - interface class 'xxx' used as base for dll - interface class 'yyy'"
